...
const CarrouselAll = ()=>{
    ...
    return(
        ...
        <img src="./buttons/left.png" alt="leftButton" onClick={previous} className="w-8 h-8 sm:w-10 sm:h-10 cursor-pointer"></img>
        ...
        <img src="./buttons/right.png" alt="rightButton" onClick={next} className="w-8 h-8 sm:w-10 sm:h-10 cursor-pointer"></img>
    </div>
</div>
    )
}
